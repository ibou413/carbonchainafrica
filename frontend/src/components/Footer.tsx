        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              La première plateforme décentralisée de crédits carbone en Afrique, propulsée par Hedera.
            </p>
          ...
          {/* Plateforme */}
          <div>
            <h3 className="text-white mb-4">Plateforme</h3>
            <ul className="space-y-3">
              <li><Link href="/marketplace" className="hover:text-emerald-400 transition-colors">Marketplace</Link></li>
              <li><Link href="/#featured" className="hover:text-emerald-400 transition-colors">Crédits Vedette</Link></li>
              <li><Link href="/#how-it-works" className="hover:text-emerald-400 transition-colors">Comment ça marche</Link></li>
              <li><Link href="/dashboard" className="hover:text-emerald-400 transition-colors">Tableau de Bord</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="hover:text-emerald-400 transition-colors">Guide de Démarrage</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Kinshasa, RDC<br />Nairobi, Kenya</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-4">
              <p className="text-gray-400 text-sm">
                © 2024 CarbonChain Africa. Tous droits réservés.
              </p>
              <button 
