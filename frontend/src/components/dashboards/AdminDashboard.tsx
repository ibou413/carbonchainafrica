...
export function AdminDashboard() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast.success(`Vérificateur ${formData.name} ajouté avec succès!`);
  ...
  const handleToggleStatus = (id: number) => {
    ...
    toast.info(`Vérificateur ${verifier?.name} ${verifier?.isActive ? 'désactivé' : 'activé'}`);
  };

  const handleDelete = (id: number) => {
    const verifier = verifiers.find(v => v.id === id);
    setVerifiers(verifiers.filter(v => v.id !== id));
    toast.error(`Vérificateur ${verifier?.name} supprimé`);
  };
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-600">Gérez les vérificateurs de la plateforme</p>
        </div>
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Ajouter un Nouveau Vérificateur</DialogTitle>
              <DialogDescription>
                Ajoutez un organisme de certification accrédité à la plateforme
              </DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="jean@organisation.org"
                  required
                />
              </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">Vérificateurs Actifs</p>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">Total Vérificateurs</p>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl text-gray-900">Vérificateurs Actifs</h2>
                ...
                <div className="flex items-start gap-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500 mt-3">
                      Ajouté le {new Date(verifier.addedAt).toLocaleDateString('fr-FR')}
                    </p>
                  </div>
                </div>
      ...
      {inactiveVerifiers.length > 0 && (
        <div className="space-y-4">
          <h2 className="text-2xl text-gray-900">Vérificateurs Désactivés</h2>
          <div className="grid gap-4">
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <Badge className="bg-gray-200 text-gray-700">INACTIF</Badge>
                      </div>
      ...
      {verifiers.length === 0 && (
        <Card className="p-12 text-center">
          ...
          <h3 className="text-gray-900 mb-2">Aucun vérificateur</h3>
          <p className="text-gray-600 mb-6">
            Commencez par ajouter votre premier vérificateur accrédité
          </p>
          <Button 
