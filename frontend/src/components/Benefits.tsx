  ...
  const benefits = [
    {
      icon: ShoppingBag,
      title: "Acheteurs",
      description: "Compensez votre empreinte carbone avec des crédits vérifiés",
      features: ["Prix transparents", "Portfolio digital", "Certificats authentiques"],
      color: "blue"
    },
    {
      icon: Leaf,
      title: "Vendeurs",
      description: "Monétisez vos projets environnementaux",
      features: ["Tokenisation NFT", "Accès global", "Paiements rapides"],
      color: "emerald"
    }
  ];
  ...
  const platformFeatures = [
    {
      ...
      description: "Chaque projet est validé par des organismes accrédités"
    },
    {
      icon: Zap,
      title: "Transactions Instantanées",
      description: "Confirmation en 3-5 secondes grâce à Hedera"
    },
    {
      icon: TrendingUp,
      title: "Prix de Marché",
      description: "Découverte de prix transparente via la marketplace"
    },
    {
      icon: Globe,
      title: "Impact Global",
      description: "Soutenez des projets africains qui comptent"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl text-gray-900 mb-4">
            Pourquoi CarbonChain Africa ?
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Une marketplace simple, sécurisée et transparente pour tous
          </p>
        </div>
